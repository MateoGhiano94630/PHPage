...
<head>
  ...
  <script defer src=".vscode/static/js/welcome.js"></script>
  <?php endif ?>
  
  <!-- defer para que no carge primero que el html -->
  <!-- LAS URL INCLUYEN EL PROTOCOLO LAS URI NO LINEA 25 QUITAMOS QUERY URL = HTTP://GOOGLE.COM URI = /GOOGLE.COM  -->
